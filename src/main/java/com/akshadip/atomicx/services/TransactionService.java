...
public class TransactionService {
    ...
    /**
     * Retrieves the balance of the user specified by the given username.
     *
     * @param userName the username of the account holder whose balance is to be retrieved
     * @return the current balance of the user as a BigDecimal
     * @throws UserDoesnotExist if the user does not exist in the system
     */
